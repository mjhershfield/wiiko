...
void UUID4_PREFIX(seed)(uint64_t* state)
{
  ...
  *state = state0++ + ((rand() ^ rand()));

  *state = *state * 6364136223846793005u + ((uint64_t)(UUID4_PREFIX(mix)(UUID4_PREFIX(hash)(rand()), UUID4_PREFIX(hash)(rand()))) << 32);
  *state = *state * 6364136223846793005u + rand();
  *state = *state * 6364136223846793005u + (uintptr_t)UUID4_PREFIX(gen);
}
